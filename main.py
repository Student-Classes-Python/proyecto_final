...
player = Actor('player', center=(WIDTH // 2, HEIGHT - 60))
...
attractions = [
    Actor('attractions/enchanted_castle', center=(200, HEIGHT - 300)),
    Actor('attractions/grand_ferris_wheel', center=(400, HEIGHT - 300)),
    Actor('attractions/pirate_ship_swings', center=(600, HEIGHT - 300)),
    Actor('attractions/thunder_loops', center=(800, HEIGHT - 300)),
    Actor('attractions/viking_ship', center=(1000, HEIGHT - 300)),
]
